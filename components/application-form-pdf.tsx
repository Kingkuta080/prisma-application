...
export function ApplicationFormPdf({
  ...
  const styles = StyleSheet.create({
    ...
    thDesc: { width: "50%" },
    thSession: { width: "22%" },
    thAmount: { width: "28%", textAlign: "right" },
    tableRow: {
      flexDirection: "row",
      paddingVertical: 10,
      paddingHorizontal: 12,
    ...
    tableRowAlt: {
      backgroundColor: colorSecondary + "40",
    },
    tdDesc: { width: "50%", fontSize: 10 },
    tdSession: { width: "22%", fontSize: 10 },
    tdAmount: { width: "28%", fontSize: 10, textAlign: "right" },
    totalRow: {
      flexDirection: "row",
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.twoCol}>
          <View style={styles.col}>
            ...
            <View style={styles.metaRow}>
              ...
              <Text style={styles.metaValue}>{sessionYear - 1} / {sessionYear}</Text>
            </View>
            <View style={styles.metaRow}>
        ...
        <View style={styles.table}>
          <View style={styles.tableHeader}>
            <Text style={[styles.tableHeaderText, styles.thDesc]}>Description</Text>
            <Text style={[styles.tableHeaderText, styles.thSession]}>Session</Text>
            <Text style={[styles.tableHeaderText, styles.thAmount]}>Amount</Text>
          </View>
